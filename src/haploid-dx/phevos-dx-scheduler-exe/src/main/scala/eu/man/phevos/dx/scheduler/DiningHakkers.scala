package eu.man.phevos.dx.scheduler
...
object DiningHakkers {
  ...
  val system = com.ibm.haploid.core.concurrent.actorsystem

  def run {
    //Create 5 chopsticks
    val chopsticks = for (i ← 1 to 5) yield system.actorOf(Props[Chopstick], "Chopstick_" + i)
